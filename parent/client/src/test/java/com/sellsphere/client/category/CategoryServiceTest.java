...
class CategoryServiceTest {
    ...
    @Test
    void givenInvalidAlias_whenGetCategoryByAlias_thenThrowException() {
        // Given
        given(categoryRepository.findByAliasAndEnabledIsTrue("invalid")).willReturn(Optional.empty());

        // When / Then
        assertThatThrownBy(() -> categoryService.getCategoryByAlias("invalid"))
